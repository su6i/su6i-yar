...
async def analyze_text_gemini(text, status_msg=None, lang_code="fa"):
    ...
    try:
        ...
        prompt_text = (
            ...
            "━━━━━━━━━━━━━━\n"
            f"{text_claim_label} [ONLY number, e.g. '17%' NOT a sentence]\n"
            f"{research_label} [ONLY number from research, e.g. '17.1%' or 'Not specified']\n"
            f"{conclusion_label} [Brief explanation - max 15 words]\n"
            f"{status_label} [✅/❌/⚠️]\n"
            "━━━━━━━━━━━━━━\n"
            "(Repeat SEPARATELY for each of MAX 3-4 claims - do NOT combine claims)\n\n"
            f"{result_label}\n"
