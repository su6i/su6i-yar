...
async def analyze_text_gemini(text, status_msg=None, lang_code="fa"):
    ...
    try:
        ...
        prompt_text = (
            ...
            f"{conclusion_label} Research confirms fatigue increases by this amount\n"
            f"{status_label} ✅\n"
            "━━━━━━━━━━━━━━\n"
            f"{text_claim_label} 45%\n"
            f"{research_label} Not specified in research\n"
            f"{conclusion_label} Research shows concentration decreases but exact percentage varies\n"
            f"{status_label} ⚠️\n"
            "━━━━━━━━━━━━━━\n"
