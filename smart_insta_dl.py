...
async def analyze_text_gemini(text, status_msg=None, lang_code="fa"):
    ...
    try:
        ...
        prompt_text = (
            ...
            f"{research_label} [The ACTUAL number/percentage found in research - DO NOT copy from text claim if different!]\n"
            f"{conclusion_label} [Brief explanation of what research found - max 15 words]\n"
            f"{status_label} [✅/❌/⚠️]\n"
            "━━━━━━━━━━━━━━\n"
